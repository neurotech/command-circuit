...
export const TextInput = ({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div
        className="text-xs data-[valid=false]:text-rose-400"
        data-valid={valid}
      >
        {label}
      </div>
